...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        title_lbl  = Label(bg_img,text = "FACE RECOGNITION ATTENDANCE SYSTEM SOFTWARE",font= ('lucida',35,"bold"),bg='white',fg='red')
        ...
        #Student Button
        img4 = Image.open("images/student-icon.jpg")
        ...
        #Detect Face
        img5 = Image.open("images/employee_1559924.jpg")
        ...
        # Attendance Report
        img6 = Image.open("images/admin-icon.png")
        ...
        # Help Desk
        img7 = Image.open("images/employee_bg_image.jpg")
        ...
        b4_4 = Button(bg_img, text='Help Desk', cursor='hand2', font=('goudy', 15, "bold"), bg='dark blue',
                      fg='white')
        b4_4.place(x=1100, y=300, width=220, height=40)


        #Train Face button
        img8 = Image.open("images/student-boy-sitting-in-keyboard-with-laptop-vector-28086007.jpg")
        ...
        # Photos button
        img9 = Image.open("images/student-boy-sitting-in-keyboard-with-laptop-vector-28086007.jpg")
        ...
        # Developer button
        img10 = Image.open("images/student-boy-sitting-in-keyboard-with-laptop-vector-28086007.jpg")
        img10 = img10.resize((220, 220), Image.ANTIALIAS)
        self.photoimg10 = ImageTk.PhotoImage(img9)

        b10 = Button(bg_img, image=self.photoimg10, cursor='hand2')
        b10.place(x=800, y=400, width=220, height=220)

        b10_10 = Button(bg_img, text='Developer', cursor='hand2', font=('goudy', 15, "bold"), bg='dark blue',
                      fg='white')
        b10_10.place(x=800, y=600, width=220, height=40)

        # exit button
        img11 = Image.open("images/student-boy-sitting-in-keyboard-with-laptop-vector-28086007.jpg")
        img11 = img11.resize((220, 220), Image.ANTIALIAS)
        self.photoimg11 = ImageTk.PhotoImage(img11)

        b11 = Button(bg_img, image=self.photoimg11,command=self.exit ,cursor='hand2')
        b11.place(x=1100, y=400, width=220, height=220)

        b11_11 = Button(bg_img, text='Exit', cursor='hand2',command=self.exit,font=('goudy', 15, "bold"), bg='dark blue',
                      fg='white')
        b11_11.place(x=1100, y=600, width=220, height=40)
